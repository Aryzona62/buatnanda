...
<div class="col-md-12 mb-4">
    ...
    <div class="card-body my-4">
        ...
        <div class="col">
            ...
            <div class="row mb-4">
            <div class="col-md-7">
                <p class="text-muted"> GeoFishery adalah website yang menyediakan ruang untuk petani memperoleh informasi dan edukasi. Website ini memiliki fitur utama, yaitu memberikan rekomendasi tanaman yang cocok untuk ditanam dilahan para user (petani).
