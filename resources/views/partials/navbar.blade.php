    ...
    <div class="container">
      <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="gtn-header-left">
          <!-- logo -->
          <a class="logo-default gtn-scroll-link" href="#home"><img src="{{ asset('assets/images/logo.png') }}" alt="logo" width=200 /></a>

          <!-- logo on scroll -->
          <a class="logo-alt gtn-scroll-link" href="#home"><img src="{{ asset('assets/images/logo.png') }}" alt="logo" width=200 /></a>
          <!-- logo on scroll ends -->
        </div>
        <!-- header left ends -->
