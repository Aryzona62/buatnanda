            ...
            <div class="container gtn-pb-100">
              ...
              <div class="row">
                <div class="col-12 col-md-6">
                  ...
                  <h1 style="font-size: 60px;">Ikan dengan kualitas <br />
                      Terbaik
                  </h1>
                  <p class="gtn-intro-content color-dark">
                    Beli berbagai jenis ikan segar dan berkualitas disini.
                  </p>
                ...
                <div class="col-12 col-md-6 small-device-space">
                  <img src="assets/images/tuna.png" alt="image" />
                </div>
              </div>
              <!--== row ends ==-->
            </div>
        ...
        <section id="team" class="gtn-section gtn-pt-100 gtn-pb-70">
          <div class="container">
            ...
            <div class="gtn-section-intro text-center gtn-mb-50">
              ...
              <h2 class="gtn-intro-heading">Produk-produk terbaik GeoFishery</h2>
              <p class="gtn-intro-content">Cari kebutuhan perikanan disini</p>
            </div>
            <!-- heading ends -->
