        ...
        <div class="col-12 col-md-6 small-device-space">
          ...
          <div class="gtn-section-intro text-left">
            ...
            <h2 class="gtn-intro-heading">
              Perluas<br />
              Ilmu perikanan anda disini<br />
            
            </h2>
            <p class="gtn-intro-content">
              Saksikan beberapa video tentang peternakan ikan seperti: Pembenihan ikan,
              Perawatan, perkembangbiakan ikan dan masih banyak yang lainnya.
            </p>
          </div>
          <!-- heading ends -->
  ...
  <section id="process" class="gtn-section gtn-py-100 bg-white">
    <div class="container">
        <div class="gtn-section-intro text-center gtn-mb-50">
          ...
          <h2 class="gtn-intro-heading">GeoFishery untuk peternak ikan cermat</h2>
          <p class="gtn-intro-content">
            berikut beberapa video yang dapat memberikan pengetahuan
            yang mungkin <br />
            belum anda dapatkan
          </p>
        </div>
