...
<section id="blog" class="gtn-section gtn-py-100 bg-white">
    <div class="container">
      <div class="gtn-section-intro text-center gtn-mb-50">
        ...
        <h2 class="gtn-intro-heading">Artikel Terbaru</h2>
        <p class="gtn-intro-content">
          Baca dan lihat berbagai artikel tentang perikanan<br />
          Dapatkan insight baru mengenai perikanan di Indonesia
        </p>
          ...
          <div class="col-6 col-md-4 col-sm-6 mb-5"">
            <div class="gtn-post-item">
              ...
              <span class="gtn-meta-category">{{ $ar->kategori->nama }}</span>
                ...
                <div class="hide mt-0">
                    {{-- <p class="gtn-post-excerpt">Budidaya ikan pangan merupakan suatu kegiatan menanam tanaman yang menjadi sumber karbohidrat utama....</p> --}}
